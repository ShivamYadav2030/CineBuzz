...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    {title: 'Total Revanue', value: currency + dashboardData.totalRevenue || "0", icon:CircleDollarSignIcon},
       ...
       <div className='relative flex flex-wrap gap-4 mt-6'>
        ...
        <div className='flex flex-wrap gap-4 w-full'>
          {dashboardCards.map((card,index)=>(
            <div key={index} className='flex itmes-center justify-between px-4 py-3 bg-primary/10 border border-primary/20 rounded-md max-w-50 w-full'>
              <div>
